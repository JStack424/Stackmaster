...
Current 0.4.1 automated verification passes with zero compiler warnings/errors, 86/86 pure-domain tests, and 52/52 static/repository safety checks. Core connected-workbench storage behavior from 0.4.0 has been live-tested in Valheim; the new 0.4.1 ownership lease has not. Multiplayer behavior, dedicated-server behavior, workbench extensions, and broader topology/load-unload edge cases have not yet been independently verified, so this test candidate does not claim proven multiplayer safety.
...
- Automated verification passes: zero compiler warnings/errors, 86/86 pure-domain tests, and 52/52 static/repository safety checks.
...
8. Repeat exact accounting, minimum-chest selection, connected-workbench and 20 m fallback scope, auto-sort opt-out, multi-craft/quality, deposit, replenishment, protection, and busy-message regressions.

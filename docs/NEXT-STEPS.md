...
The **1.1.1 local compatibility test candidate** carries forward the released 1.1.0 gameplay and configuration unchanged. It updates only the pinned runtime/reference boundary for Valheim 1.0.14 / Steam build 25364309 and adds independent metadata/IL checks for every patched surface, including the exact left-click/right-click inventory routing. This candidate is not published and awaits live testing.
...
- Stackmaster 1.1.1 is a local-only compatibility test candidate. It has not been pushed, tagged, released on GitHub, or uploaded to Thunderstore.
...
- Joe's in-game validation of the 0.4.2 release candidate passed. The unchanged 1.1.1 compatibility candidate, dedicated servers, workbench extensions, manual-access preemption, and broader multiplayer/topology/load-unload behavior remain independently unverified.

**1.1.1 live-test checklist:**
...
**Next handoff:** Install and live-test `JStack424-Stackmaster-1.1.1-test.zip` with the checklist above. Do not push, tag, create a GitHub Release, or upload this candidate to Thunderstore unless Joe explicitly approves it after testing.
